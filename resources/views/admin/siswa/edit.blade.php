...
<div class="container container-page py-4">
    ...
    <div class="d-flex justify-content-between align-items-center header-box mb-4">
        <h4 class="fw-bold mb-0">
            <i class="bi bi-pencil-square text-success me-2"></i> Edit Data Siswa
        </h4>
    ...
    <div class="card-main">
        <div class="mb-4">
            <h5 class="fw-bold text-dark mb-1">Formulir Pembaruan</h5>
            <p class="text-muted small">Pastikan data NIS dan Kelas sudah sesuai dengan data terbaru.</p>
        </div>
