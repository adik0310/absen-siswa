...
@section('title', 'Tambah Jadwal Mengajar - Admin')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 page-header-box">
        <div>
            <h5 class="fw-bold mb-1 text-success">
                <i class="bi bi-calendar-plus me-2"></i> Tambah Jadwal Mengajar
            </h5>
            <p class="text-muted mb-0 small">Daftarkan jadwal baru untuk pengajar dan kelas.</p>
        </div>
        ...
        <form action="{{ route('admin.jadwal.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="id_mapel" class="form-select form-select-sm" required>
                        ...
                        @foreach($mapelList as $m)
                            <option value="{{ $m->id_mata_pelajaran }}" {{ old('id_mapel') == $m->id_mata_pelajaran ? 'selected' : '' }}>
                                {{ $m->nama_mapel }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="ruangan" value="{{ old('ruangan') }}" class="form-control form-control-sm" maxlength="100" placeholder="Contoh: Gedung A Lt. 2">
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-success-custom btn-custom shadow-sm">
